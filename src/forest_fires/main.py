...
from data_preprocessing.data_downloader import download_forestfire_class1, download_esc50_class0
from data_preprocessing.feature_extractor_ast import AudioDatasetWave, AudioDatasetAST
from models.mlp_classifier import LitMLP
from model_evaluation.evaluate_ast_mlp import evaluate_model
import lightning.pytorch as pl


def main(data_dir: str = "data/forest_fire_dataset",
         batch_size: int = 8,
         max_epochs: int = 5,
         device: str = None,
         checkpoint_path: str = "checkpoints/lit_mlp_checkpoint.ckpt") -> None:
    """
    ...
    Args:
        data_dir (str, optional): Root directory to store datasets. Defaults to "data/forest_fire_dataset".
    ...
    # Download datasets
    class0_dir = download_esc50_class0()
    class1_dir = download_forestfire_class1()
